...
static const mxArray *c_emlrt_marshallOut(const real_T u[60])
{
  static const int32_T iv[2] = {10, 6};
  const mxArray *m;
  const mxArray *y;
  real_T *pData;
  int32_T b_i;
...
{
  static const uint32_T uv[4] = {1678224749U, 3100984372U, 2048663372U,
                                 3417363396U};
  ...
  mv = (real_T(*)[6])mxMalloc(sizeof(real_T[6]));
