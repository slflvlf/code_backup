...
void BBS(const emlrtStack *sp, real_T eta, const real_T param_p[24], real_T
         ...
         const real_T param_ode_M[9], const real_T param_ode_D[9], const real_T
         param_ode_thrust_config[6], const struct4_T *param_ocp, const real_T
         param_x0[6], real_T *J, real_T *g)
{
  real_T p[24];
  int32_T i;
  ...
  st.site = &v_emlrtRSI;
  user_ocp(&st, xx, uu, param_uparam_Np, param_ocp->Q, param_ocp->R,
           param_ocp->Rdu, param_ocp->dF_max, param_ocp->da_max,
           param_ocp->rd_his, param_ocp->u_last, J, g);
