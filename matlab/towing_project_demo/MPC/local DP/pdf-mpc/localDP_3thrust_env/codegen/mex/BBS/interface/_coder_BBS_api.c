...
static void s_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, struct4_T y[24]);
  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  s_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 9, "mv")),
                     &thisId, y->mv);
  ...
  emlrtMsgIdentifier *parentId, struct2_T *y)
{
  ...
  l_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "u0")),
                     &thisId, y->u0);
  thisId.fIdentifier = "M";
  m_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4, "M")),
                     &thisId, y->M);
  thisId.fIdentifier = "D";
  m_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "D")),
                     &thisId, y->D);
  ...
  emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "rd")),
                     &thisId, y->rd);
  ...
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6, "rd_his")),
                     &thisId, y->rd_his);
  thisId.fIdentifier = "u_last";
  l_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 7, "u_last")),
                     &thisId, y->u_last);
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *parentId, struct4_T y[24])
{
  ...
  for (i = 0; i < 24; i++) {
    ...
    t_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i, 7, "param")),
                       &thisId);
