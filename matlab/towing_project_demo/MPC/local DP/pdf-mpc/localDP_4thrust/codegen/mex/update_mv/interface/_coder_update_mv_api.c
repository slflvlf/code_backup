...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *mv, const
  char_T *identifier, struct0_T y[32]);
...
static void d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, struct0_T y[32]);
  ...
  emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "u0")),
                     &thisId, y->u0);
  thisId.fIdentifier = "M";
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4, "M")),
                     &thisId, y->M);
  thisId.fIdentifier = "D";
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "D")),
                     &thisId, y->D);
  thisId.fIdentifier = "thrust_config";
  s_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6,
                   ...
                   *plhs[3])
{
  ...
  p_sol = (real_T (*)[32])mxMalloc(sizeof(real_T [32]));
