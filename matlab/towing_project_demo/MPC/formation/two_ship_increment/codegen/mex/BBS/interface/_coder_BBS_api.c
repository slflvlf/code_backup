  ...
  emlrtMsgIdentifier *parentId, struct2_T *y)
{
  ...
  l_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "u_last")),
                     &thisId, y->u_last);
  thisId.fIdentifier = "M";
  m_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6, "M")),
                     &thisId, y->M);
  thisId.fIdentifier = "D";
  m_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 7, "D")),
                     &thisId, y->D);
  ...
  emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  y->F_max = d_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4,
    "F_max")), &thisId);
  thisId.fIdentifier = "a_max";
  y->a_max = d_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5,
    "a_max")), &thisId);
  thisId.fIdentifier = "u_last";
