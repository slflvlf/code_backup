              ...
              const real_T p_ode_thrust_config[6], emxArray_real_T *xdot)
{
  ...
  d = 6.0 * p_ode_Nship;
  if (!(d >= 0.0)) {
    emlrtNonNegativeCheckR2012b(d, &g_emlrtDCI, sp);
  }
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    i1 = (int32_T)(d + 3.0);
    if ((i1 < 1) || (i1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, 12, &g_emlrtBCI, sp);
    }

    t1 = x[i1 - 1];
    i2 = (int32_T)(d + 1.0);
    if ((i2 < 1) || (i2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, 12, &f_emlrtBCI, sp);
    }
    ...
    df_tmp[2] = d + 3.0;
    if ((i2 < 1) || (i2 > u)) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, u, &k_emlrtBCI, sp);
    }

    i3 = (int32_T)(d + 2.0);
    if ((i3 < 1) || (i3 > u)) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, u, &k_emlrtBCI, sp);
    }

    if ((i1 < 1) || (i1 > u)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, u, &k_emlrtBCI, sp);
    }

    st.site = &s_emlrtRSI;
    indexShapeCheck(&st, u_size[0]);
    if (p3 > b_u) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, b_u, &l_emlrtBCI, sp);
    }

    if (p2 > b_u) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, b_u, &l_emlrtBCI, sp);
    }

    if (p1 > b_u) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, b_u, &l_emlrtBCI, sp);
    }

    if (i2 > 12) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, 12, &m_emlrtBCI, sp);
    }

    if (i3 > 12) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, 12, &m_emlrtBCI, sp);
    }

    if (i1 > 12) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, 12, &m_emlrtBCI, sp);
    }
    ...
    for (p3 = 0; p3 < 3; p3++) {
      ...
      if ((p2 < 1) || (p2 > p1)) {
        emlrtDynamicBoundsCheckR2012b(p2, 1, p1, &h_emlrtBCI, sp);
      }
    ...
    for (i1 = 0; i1 < 3; i1++) {
      i2 = (int32_T)v_tmp[i1];
      if ((i2 < 1) || (i2 > p1)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, p1, &i_emlrtBCI, sp);
      }
