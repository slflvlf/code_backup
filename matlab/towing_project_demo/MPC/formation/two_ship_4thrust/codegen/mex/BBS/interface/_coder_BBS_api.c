...
static void u_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, struct4_T y[64]);
  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  p_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 7, "ocp")),
                     &thisId, &y->ocp);
  thisId.fIdentifier = "x0";
  n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 8, "x0")),
                     &thisId, y->x0);
  thisId.fIdentifier = "mv";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 9, "mv")),
                     &thisId, y->mv);
  ...
  emlrtMsgIdentifier *parentId, struct2_T *y)
{
  ...
  l_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "M")),
                     &thisId, y->M);
  thisId.fIdentifier = "D";
  l_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4, "D")),
                     &thisId, y->D);
  thisId.fIdentifier = "thrust_config";
  m_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5,
    "thrust_config")), &thisId, y->thrust_config);
  thisId.fIdentifier = "x0";
  n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6, "x0")),
                     &thisId, y->x0);
  thisId.fIdentifier = "u0";
  o_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 7, "u0")),
                     &thisId, y->u0);
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 0, "Q")),
                     &thisId, y->Q);
  thisId.fIdentifier = "R";
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 1, "R")),
                     &thisId, y->R);
  thisId.fIdentifier = "Rdu";
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 2, "Rdu")),
                     &thisId, y->Rdu);
  thisId.fIdentifier = "rd";
  s_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "rd")),
                     &thisId, y->rd);
  ...
  t_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6, "rd_his")),
                     &thisId, y->rd_his);
  thisId.fIdentifier = "u_last";
  o_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 7, "u_last")),
                     &thisId, y->u_last);
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *parentId, struct4_T y[64])
{
  ...
  for (i = 0; i < 64; i++) {
    ...
    v_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i, 7, "param")),
                       &thisId);
...
static void v_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId)
{
  kb_emlrt_marshallIn(sp, emlrtAlias(u), parentId);
  emlrtDestroyArray(&u);
}
...
void BBS_api(BBSStackData *SD, const mxArray * const prhs[2], int32_T nlhs,
             const mxArray *plhs[2])
{
  ...
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "param", &SD->f0.param);

  /* Invoke the target function */
  BBS(&st, eta, &SD->f0.param, &J, &g);
