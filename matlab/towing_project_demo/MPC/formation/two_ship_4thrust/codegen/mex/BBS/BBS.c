         ...
         *g)
{
  ...
  memcpy(&p[0], &param->p[0], 64U * sizeof(real_T));
  ...
  i = (int32_T)param->ell;
  if ((i < 1) || (i > 64)) {
    emlrtDynamicBoundsCheckR2012b(i, 1, 64, &emlrtBCI, sp);
  }
  ...
  simulate_ol(&st, p, param->ode.Nship, param->ode.tau, param->ode.rk_order,
              ...
              param->ode.x0, param->uparam.nu, param->uparam.Np, param->uparam.R,
              unusedU0, xx, uu);
  st.site = &b_emlrtRSI;
  user_ocp(&st, xx, uu, param->ode.Nship, param->ode.u0, param->uparam.Np,
           param->ocp.Q, param->ocp.R, param->ocp.Rdu, param->ocp.rd,
           param->ocp.dF_max, param->ocp.da_max, J, g);
