            ...
            emxArray_real_T *b)
{
  ...
  outsize_idx_0 = outsize_idx_0_tmp << 3;
  if (!(outsize_idx_0 == 8.0 * (real_T)outsize_idx_0_tmp)) {
    y = NULL;
  ...
  emxEnsureCapacity_real_T(sp, b, itilerow, &ob_emlrtRTEI);
  st.site = &cc_emlrtRSI;
