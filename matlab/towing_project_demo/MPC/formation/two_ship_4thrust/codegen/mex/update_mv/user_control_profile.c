...
static emlrtRTEInfo hb_emlrtRTEI = { 8,/* lineNo */
  ...
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship_4thrust\\user_control_profile.m"/* pName */
};

/* Function Definitions */
void user_control_profile(const emlrtStack *sp, const real_T p[64], real_T
  p_uparam_nu, real_T p_uparam_Np, const real_T p_uparam_R[20480],
  emxArray_real_T *u_profile)
{
  ...
  emxEnsureCapacity_real_T(sp, u_profile, i, &hb_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
