...
static emlrtRSInfo vb_emlrtRSI = { 28, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship_edit\\user_ocp.m"/* pathName */
};
...
static emlrtRTEInfo kb_emlrtRTEI = { 13,/* lineNo */
  1,                                   /* colNo */
  "user_ocp",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship_edit\\user_ocp.m"/* pName */
};

static emlrtRTEInfo lb_emlrtRTEI = { 145,/* lineNo */
  38,                                  /* colNo */
  "unaryMinOrMax",                     /* fName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pName */
};
              ...
              real_T p_ocp_u_last[12], real_T *J, real_T *g)
{
  ...
  *J = 0.0;
  ...
  emxInit_real_T(sp, &x, 1, &lb_emlrtRTEI, true);
  for (i = 0; i < loop_ub; i++) {
    u = i + 1U;
    if (u == 1U) {
      /*          du=uu(1, :)'-p_ode.u0; */
      if (1 > uu->size[0]) {
        emlrtDynamicBoundsCheckR2012b(1, 1, uu->size[0], &fb_emlrtBCI, sp);
      }
      ...
      if ((int32_T)u > uu->size[0]) {
        emlrtDynamicBoundsCheckR2012b((int32_T)u, 1, uu->size[0], &eb_emlrtBCI,
          sp);
      }
      ...
      if ((i < 1) || (i > uu->size[0])) {
        emlrtDynamicBoundsCheckR2012b(i, 1, uu->size[0], &db_emlrtBCI, sp);
      }
    ...
    a = x->size[0];
    x->size[0] = 12;
    emxEnsureCapacity_real_T(&e_st, x, a, &lb_emlrtRTEI);
    for (a = 0; a < 12; a++) {
    ...
    if (idx == 0) {
      a = (int32_T)(i + 1U);
      if (a > h1_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(a, 1, h1_du->size[0], &gb_emlrtBCI, &f_st);
      }
    ...
    if (idx == 0) {
      a = (int32_T)(i + 1U);
      if (a > h2_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(a, 1, h2_du->size[0], &hb_emlrtBCI, &f_st);
      }
    ...
    a = (int32_T)(i + 2U);
    if ((a < 1) || (a > xx->size[0])) {
      emlrtDynamicBoundsCheckR2012b(a, 1, xx->size[0], &cb_emlrtBCI, sp);
    }
    ...
    a = i + 1;
    if (a > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(a, 1, uu->size[0], &ab_emlrtBCI, sp);
    }

    st.site = &vb_emlrtRSI;
    a = i + 1;
    if (a > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(a, 1, uu->size[0], &bb_emlrtBCI, &st);
    }
