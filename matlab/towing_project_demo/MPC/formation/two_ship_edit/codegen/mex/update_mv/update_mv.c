               ...
               *u_sol, real_T p_sol[48], emxArray_real_T *lesp)
{
  ...
  lesp->size[0] = 48;
  emxEnsureCapacity_real_T(sp, lesp, i, &r_emlrtRTEI);
  ell = Nloop * 48.0;
  i = (int32_T)ell;
  if (ell != i) {
  ...
  lesp->size[1] = i;
  emxEnsureCapacity_real_T(sp, lesp, b_i, &r_emlrtRTEI);
  ell = Nloop * 48.0;
  i = (int32_T)ell;
  if (ell != i) {
  ...
  emxInit_real_T(sp, &b_lesp, 2, &s_emlrtRTEI, true);
  i = b_lesp->size[0] * b_lesp->size[1];
  b_lesp->size[0] = 48;
  b_lesp->size[1] = loop_ub;
  emxEnsureCapacity_real_T(sp, b_lesp, i, &s_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
    for (b_i = 0; b_i < 48; b_i++) {
      i1 = b_i + 48 * i;
  ...
  emxEnsureCapacity_real_T(sp, lesp, i, &t_emlrtRTEI);
