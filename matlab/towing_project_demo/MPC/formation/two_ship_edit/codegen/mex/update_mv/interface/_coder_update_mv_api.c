  ...
  emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "M")),
                     &thisId, y->M);
  thisId.fIdentifier = "D";
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6, "D")),
                     &thisId, y->D);
  thisId.fIdentifier = "thrust_config";
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 7,
...
{
  emlrtMsgIdentifier thisId;
  static const char * fieldNames[7] = { "Q", "R", "Rdu", "dF_max", "da_max",
    "rd", "u_last" };
  ...
  y->dF_max = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3,
    "dF_max")), &thisId);
  thisId.fIdentifier = "da_max";
  y->da_max = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4,
    "da_max")), &thisId);
  thisId.fIdentifier = "rd";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "rd")),
                     &thisId, y->rd);
                   ...
                   *plhs[3])
{
  ...
  emxInit_real_T(&st, &u_sol, 2, &mb_emlrtRTEI, true);
  emxInit_real_T(&st, &lesp, 2, &mb_emlrtRTEI, true);
