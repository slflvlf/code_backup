              ...
              emxArray_real_T *xdot)
{
  ...
  if (4 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(4, 1, u_size[0], &s_emlrtBCI, sp);
  }

  if (5 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(5, 1, 4, &s_emlrtBCI, sp);
  }

  if (6 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(6, 1, 5, &s_emlrtBCI, sp);
  }
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    indexShapeCheck(&st, u_size[0]);
    if (p1 > u) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, u, &u_emlrtBCI, sp);
    }

    if (p2 > u) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, u, &u_emlrtBCI, sp);
    }

    if (p3 > u) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, u, &u_emlrtBCI, sp);
    }
    ...
    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &v_emlrtBCI, sp);
    }

    b_unnamed_idx_0 = x[p1 - 1];
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &v_emlrtBCI, sp);
    }

    unnamed_idx_1 = x[p2 - 1];
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &v_emlrtBCI, sp);
    }
    ...
    if ((i2 < 1) || (i2 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, b_u, &w_emlrtBCI, sp);
    }

    i3 = (int32_T)(unnamed_idx_0 + 2.0);
    if ((i3 < 1) || (i3 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, b_u, &w_emlrtBCI, sp);
    }

    if ((i1 < 1) || (i1 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, b_u, &w_emlrtBCI, sp);
    }
    ...
    unnamed_idx_2 = x[p3 - 1];
    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &y_emlrtBCI, sp);
    }

    unnamed_idx_0 = x[p1 - 1];
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &y_emlrtBCI, sp);
    }

    R_tmp = x[p2 - 1];
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &y_emlrtBCI, sp);
    }
