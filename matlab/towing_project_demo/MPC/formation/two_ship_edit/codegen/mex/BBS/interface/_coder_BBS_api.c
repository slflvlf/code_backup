  ...
  emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  y->dF_max = d_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3,
    "dF_max")), &thisId);
  thisId.fIdentifier = "da_max";
  y->da_max = d_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4,
    "da_max")), &thisId);
  thisId.fIdentifier = "rd";
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "rd")),
                     &thisId, y->rd);
