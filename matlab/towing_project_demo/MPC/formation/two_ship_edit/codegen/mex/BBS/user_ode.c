...
static emlrtRSInfo r_emlrtRSI = { 14,  /* lineNo */
  "user_ode",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship_edit\\user_ode.m"/* pathName */
};
...
static emlrtRTEInfo g_emlrtRTEI = { 22,/* lineNo */
  13,                                  /* colNo */
  "user_ode",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship_edit\\user_ode.m"/* pName */
};
...
static emlrtRSInfo rb_emlrtRSI = { 53, /* lineNo */
  "flt2str",                           /* fcnName */
              ...
              emxArray_real_T *xdot)
{
  ...
  if (4 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(4, 1, u_size[0], &i_emlrtBCI, sp);
  }

  if (5 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(5, 1, 4, &i_emlrtBCI, sp);
  }

  if (6 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(6, 1, 5, &i_emlrtBCI, sp);
  }

  /*  ´¬µÄ¸öÊý */
  unnamed_idx_0 = 6.0 * p_ode_Nship;
  if (!(unnamed_idx_0 >= 0.0)) {
    emlrtNonNegativeCheckR2012b(unnamed_idx_0, &g_emlrtDCI, sp);
  }

  if (unnamed_idx_0 != (int32_T)muDoubleScalarFloor(unnamed_idx_0)) {
    emlrtIntegerCheckR2012b(unnamed_idx_0, &f_emlrtDCI, sp);
  }
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if ((i1 < 1) || (i1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, 12, &f_emlrtBCI, sp);
    }
    ...
    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &j_emlrtBCI, sp);
    }

    p2 = (int32_T)(unnamed_idx_0 + 5.0);
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &j_emlrtBCI, sp);
    }

    p3 = (int32_T)(unnamed_idx_0 + 6.0);
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &j_emlrtBCI, sp);
    }

    st.site = &s_emlrtRSI;
    indexShapeCheck(&st, u_size[0]);
    if (p1 > u) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, u, &k_emlrtBCI, sp);
    }

    if (p2 > u) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, u, &k_emlrtBCI, sp);
    }

    if (p3 > u) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, u, &k_emlrtBCI, sp);
    }
    ...
    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &l_emlrtBCI, sp);
    }

    b_unnamed_idx_0 = x[p1 - 1];
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &l_emlrtBCI, sp);
    }

    unnamed_idx_1 = x[p2 - 1];
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &l_emlrtBCI, sp);
    }
    ...
    for (i2 = 0; i2 < 3; i2++) {
      i3 = (int32_T)b_B1[i2];
      if ((i3 < 1) || (i3 > itmp)) {
        emlrtDynamicBoundsCheckR2012b(i3, 1, itmp, &g_emlrtBCI, sp);
      }
    ...
    if ((i2 < 1) || (i2 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, b_u, &m_emlrtBCI, sp);
    }

    i3 = (int32_T)(unnamed_idx_0 + 2.0);
    if ((i3 < 1) || (i3 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, b_u, &m_emlrtBCI, sp);
    }

    if ((i1 < 1) || (i1 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, b_u, &m_emlrtBCI, sp);
    }

    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &n_emlrtBCI, sp);
    }

    b_unnamed_idx_0 = x[p1 - 1];
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &n_emlrtBCI, sp);
    }

    unnamed_idx_1 = x[p2 - 1];
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &n_emlrtBCI, sp);
    }

    unnamed_idx_2 = x[p3 - 1];
    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &o_emlrtBCI, sp);
    }

    unnamed_idx_0 = x[p1 - 1];
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &o_emlrtBCI, sp);
    }

    R_tmp = x[p2 - 1];
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &o_emlrtBCI, sp);
    }
    ...
    for (i1 = 0; i1 < 3; i1++) {
      ...
      if ((p1 < 1) || (p1 > itmp)) {
        emlrtDynamicBoundsCheckR2012b(p1, 1, itmp, &h_emlrtBCI, sp);
      }
