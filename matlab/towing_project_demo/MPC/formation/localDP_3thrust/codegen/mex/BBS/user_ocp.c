...
static emlrtRSInfo x_emlrtRSI = { 19,  /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\nlmpc\\localDP_3thrust\\user_ocp.m"/* pathName */
};
...
static emlrtBCInfo g_emlrtBCI = { -1,  /* iFirst */
  ...
  "uu",                                /* aName */
  "user_ocp",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\nlmpc\\localDP_3thrust\\user_ocp.m",/* pName */
  0                                    /* checkKind */
};
...
void user_ocp(const emlrtStack *sp, const emxArray_real_T *xx, const
              ...
              p_ocp_Rdu[36], const real_T p_ocp_rd[3], real_T p_ocp_dF_max,
  ...
  *J = 0.0;
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    if (idx == 0) {
      a = (int32_T)(i + 1U);
      if (a > h1_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(a, 1, h1_du->size[0], &n_emlrtBCI, &f_st);
      }
    ...
    if (idx == 0) {
      a = (int32_T)(i + 1U);
      if (a > h2_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(a, 1, h2_du->size[0], &o_emlrtBCI, &f_st);
      }
