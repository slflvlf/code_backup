...
static emlrtRSInfo vb_emlrtRSI = { 27, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship1\\user_ocp.m"/* pathName */
};
...
static emlrtRSInfo lc_emlrtRSI = { 924,/* lineNo */
  "minOrMaxRealVector",                /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo mc_emlrtRSI = { 975,/* lineNo */
  "findFirst",                         /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo nc_emlrtRSI = { 992,/* lineNo */
...
static emlrtRTEInfo ib_emlrtRTEI = { 15,/* lineNo */
  1,                                   /* colNo */
  "user_ocp",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship1\\user_ocp.m"/* pName */
};
...
static emlrtRTEInfo kb_emlrtRTEI = { 27,/* lineNo */
  23,                                  /* colNo */
  "user_ocp",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship1\\user_ocp.m"/* pName */
};

static emlrtRTEInfo lb_emlrtRTEI = { 28,/* lineNo */
  23,                                  /* colNo */
  "user_ocp",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship1\\user_ocp.m"/* pName */
};

static emlrtRTEInfo mb_emlrtRTEI = { 9,/* lineNo */
  1,                                   /* colNo */
  "user_ocp",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship1\\user_ocp.m"/* pName */
};
              ...
              p_ocp_xd_his[240], real_T *J, real_T *g)
{
  ...
  emxInit_real_T(sp, &du_max, 1, &mb_emlrtRTEI, true);
  emxInit_real_T(sp, &h1_du, 1, &ib_emlrtRTEI, true);
  ...
  *J = 0.0;
  ...
  emxEnsureCapacity_real_T(sp, h1_du, n, &ib_emlrtRTEI);
  if (p_uparam_Np != a) {
    emlrtIntegerCheckR2012b(p_uparam_Np, &l_emlrtDCI, sp);
  }
  ...
  emxInit_real_T(sp, &h2_du, 1, &jb_emlrtRTEI, true);
  if (p_uparam_Np != a) {
  ...
  emxEnsureCapacity_real_T(sp, h2_du, n, &jb_emlrtRTEI);
  ...
  emxInit_real_T(sp, &varargin_1, 1, &kb_emlrtRTEI, true);
  for (i = 0; i < loop_ub; i++) {
    u = i + 1U;
    if (u == 1U) {
      if (1 > uu->size[0]) {
    ...
    emxEnsureCapacity_real_T(&st, varargin_1, a, &kb_emlrtRTEI);
    for (a = 0; a < n; a++) {
    ...
    if (varargin_1->size[0] <= 2) {
      if (varargin_1->size[0] == 1) {
        a = (int32_T)(i + 1U);
        if (a > h1_du->size[0]) {
          emlrtDynamicBoundsCheckR2012b(a, 1, h1_du->size[0], &cb_emlrtBCI,
            &f_st);
        }
    ...
    if (varargin_1->size[0] <= 2) {
      if (varargin_1->size[0] == 1) {
        a = (int32_T)(i + 1U);
        if (a > h2_du->size[0]) {
          emlrtDynamicBoundsCheckR2012b(a, 1, h2_du->size[0], &db_emlrtBCI,
            &f_st);
        }
    ...
    a = (int32_T)(i + 2U);
    if ((a < 1) || (a > xx->size[0])) {
      emlrtDynamicBoundsCheckR2012b(a, 1, xx->size[0], &x_emlrtBCI, sp);
    }
    ...
    a = i + 1;
    if (a > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(a, 1, uu->size[0], &v_emlrtBCI, sp);
    }

    st.site = &xb_emlrtRSI;
    a = i + 1;
    if (a > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(a, 1, uu->size[0], &w_emlrtBCI, &st);
    }
