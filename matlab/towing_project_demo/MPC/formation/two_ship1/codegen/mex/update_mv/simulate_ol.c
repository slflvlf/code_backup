                 ...
                 *tt, emxArray_real_T *xx, emxArray_real_T *uu)
{
  ...
  emxInit_real_T(sp, &r, 2, &bb_emlrtRTEI, true);
  ...
  emxInit_real_T(sp, &k1, 1, &cb_emlrtRTEI, true);
  emxInit_real_T(sp, &k2, 1, &db_emlrtRTEI, true);
  emxInit_real_T(sp, &k3, 1, &eb_emlrtRTEI, true);
  emxInit_real_T(sp, &k4, 1, &fb_emlrtRTEI, true);
  if (0 <= i - 1) {
    u_size[0] = b_i;
  }
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (p_ode_rk_order == 1.0) {
      ...
      i1 = k4->size[0];
      k4->size[0] = k1->size[0];
      emxEnsureCapacity_real_T(&st, k4, i1, &x_emlrtRTEI);
      loop_ub = k1->size[0];
      for (i1 = 0; i1 < loop_ub; i1++) {
