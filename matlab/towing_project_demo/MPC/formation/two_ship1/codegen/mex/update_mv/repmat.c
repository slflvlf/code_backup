...
static emlrtDCInfo o_emlrtDCI = { 31,  /* lineNo */
  14,                                  /* colNo */
  "repmat",                            /* fName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\lib\\matlab\\elmat\\repmat.m",/* pName */
  4                                    /* checkKind */
...
void repmat(const emlrtStack *sp, real_T varargin_1, emxArray_real_T *b)
{
  real_T b_varargin_1;
  ...
  int32_T k;
  static const real_T a[6] = { 100.0, 100.0, 100.0, 0.3490658503988659,
  ...
  if (!(varargin_1 >= 0.0)) {
    emlrtNonNegativeCheckR2012b(varargin_1, &o_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, b, itilerow, &nb_emlrtRTEI);
  st.site = &dc_emlrtRSI;
