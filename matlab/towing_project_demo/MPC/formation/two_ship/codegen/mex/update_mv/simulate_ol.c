...
static emlrtRTEInfo eb_emlrtRTEI = { 8,/* lineNo */
  9,                                   /* colNo */
  "one_step",                          /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\one_step.m"/* pName */
};

static emlrtRTEInfo fb_emlrtRTEI = { 9,/* lineNo */
  9,                                   /* colNo */
  "one_step",                          /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\one_step.m"/* pName */
};
                 ...
                 *tt, emxArray_real_T *xx, emxArray_real_T *uu)
{
  ...
  xx->size[0] = i1;
  xx->size[1] = 12;
  emxEnsureCapacity_real_T(sp, xx, i, &w_emlrtRTEI);
  if (!(p_uparam_Np + 1.0 >= 0.0)) {
  ...
  emxInit_real_T(sp, &r, 2, &db_emlrtRTEI, true);
  ...
  i = tt->size[0];
  tt->size[0] = r->size[1];
  emxEnsureCapacity_real_T(sp, tt, i, &y_emlrtRTEI);
  loop_ub = r->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(sp, &k1, 1, &eb_emlrtRTEI, true);
  emxInit_real_T(sp, &k2, 1, &fb_emlrtRTEI, true);
  emxInit_real_T(sp, &k3, 1, &gb_emlrtRTEI, true);
  emxInit_real_T(sp, &k4, 1, &hb_emlrtRTEI, true);
  if (0 <= i - 1) {
    u_size[0] = b_i;
  }
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (p_ode_rk_order == 1.0) {
      ...
      i1 = k4->size[0];
      k4->size[0] = k3->size[0];
      emxEnsureCapacity_real_T(&st, k4, i1, &cb_emlrtRTEI);
      loop_ub = k3->size[0];
      for (i1 = 0; i1 < loop_ub; i1++) {
