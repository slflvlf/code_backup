...
static emlrtRTEInfo wb_emlrtRTEI = { 10,/* lineNo */
  21,                                  /* colNo */
  "update_sc",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_sc.m"/* pName */
};

static emlrtRTEInfo xb_emlrtRTEI = { 10,/* lineNo */
  6,                                   /* colNo */
  "update_sc",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_sc.m"/* pName */
};
...
static emlrtRTEInfo ac_emlrtRTEI = { 7,/* lineNo */
  19,                                  /* colNo */
  "update_sc",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_sc.m"/* pName */
};
               ...
               real_T Niter)
{
  ...
  if (!(Niter >= 0.0)) {
    emlrtNonNegativeCheckR2012b(Niter, &u_emlrtDCI, sp);
  }

  if (Niter != (int32_T)muDoubleScalarFloor(Niter)) {
    emlrtIntegerCheckR2012b(Niter, &t_emlrtDCI, sp);
  }

  emxInit_real_T(sp, &lesalpha, 1, &ac_emlrtRTEI, true);
  loop_ub = (int32_T)Niter;
  i = lesalpha->size[0];
  lesalpha->size[0] = loop_ub;
  emxEnsureCapacity_real_T(sp, lesalpha, i, &wb_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
    lesalpha->data[i] = 0.0;
  }

  emxInit_real_T(sp, &lesp, 1, &yb_emlrtRTEI, true);
  emlrtForLoopVectorCheckR2012b(1.0, 1.0, Niter, mxDOUBLE_CLASS, (int32_T)Niter,
    &r_emlrtRTEI, sp);
  i = lesp->size[0];
  lesp->size[0] = loop_ub;
  emxEnsureCapacity_real_T(sp, lesp, i, &xb_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    i = (int32_T)(b_i + 1U);
    if ((i < 1) || (i > lesp->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i, 1, lesp->size[0], &lb_emlrtBCI, sp);
    }

    lesp->data[i - 1] = sc_past->p;
    if (i > lesalpha->size[0]) {
      emlrtDynamicBoundsCheckR2012b(i, 1, lesalpha->size[0], &mb_emlrtBCI, sp);
    }
