...
if i == max_step
    ...
    plot_length_and_error(length_his, length_error_his,  6, 7);
    plot_coop_error(coop_error1_his, coop_error2_his, coop_error3_his, coop_error4_his, 8);
    

%     plot_controller_force(tau1_his, tauc1_his, tau2_his, tauc2_his, 6);
%     plot_controller_force(tau1_his, tau2_his, 6);
%     plot_thruster(tau1_his, taur1_his, f1_his, a1_his, 7);
%     plot_thruster(tau2_his, taur2_his, f2_his, a2_his, 8);
%     plot_thruster(tau3_his, taur3_his, f3_his, a3_his, 9);
%     plot_thruster(tau4_his, taur4_his, f4_his, a4_his, 10);
...
%% 船舶间距误差
function [] = plot_length_and_error(length_his, length_error_his,  fig_id_length, fig_id_error)
    figure(fig_id_length);
    title('多船的间距');
%     subplot(1, 2, 1)
    plot(length_his(1, :))
    hold on
    ...
    legend('length01', 'length02', 'length03', 'length04',...
        'length12', 'length13', 'length23', 'length34');
    legend boxoff
