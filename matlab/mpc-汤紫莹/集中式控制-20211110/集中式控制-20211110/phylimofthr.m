...
% u_lb=[-10;-10;-10;-10;-2*pi;-2*pi;-2*pi;-2*pi];%单位 N
% u_ub=[10;10;10;10;2*pi;2*pi;2*pi;2*pi]; 
...
% du_lb=-[2;2;2;2;deg2rad(12);deg2rad(12);deg2rad(12);deg2rad(12)];
% du_ub=[2;2;2;2;deg2rad(12);deg2rad(12);deg2rad(12);deg2rad(12)];
