...
block.Dwork(5).Data = [block.InputPort(1).Data(7), block.InputPort(1).Data(8), ...
                        block.InputPort(1).Data(9)]'; %p1
block.Dwork(6).Data = [block.InputPort(1).Data(13), block.InputPort(1).Data(14), ...
                        block.InputPort(1).Data(15)]'; %p2
% 将初始位置的角度转为弧度单位
block.Dwork(4).Data(3) = block.Dwork(4).Data(3) / 180 * pi;
block.Dwork(5).Data(3) = block.Dwork(5).Data(3) / 180 * pi;
block.Dwork(6).Data(3) = block.Dwork(6).Data(3) / 180 * pi;  
