...
QT_MOC_LITERAL(1, 5, 17), // "PreasureDataReady"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15), // "QVector<double>"
QT_MOC_LITERAL(4, 40, 3), // "msg"
QT_MOC_LITERAL(5, 44, 14), // "AngleDataReady"
QT_MOC_LITERAL(6, 59, 11) // "publishData"

    },
    "Data\0PreasureDataReady\0\0QVector<double>\0"
    "msg\0AngleDataReady\0publishData"
};
...
void Data::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PreasureDataReady((*reinterpret_cast< const QVector<double>(*)>(_a[1]))); break;
        case 1: _t->AngleDataReady((*reinterpret_cast< const QVector<double>(*)>(_a[1]))); break;
        case 2: _t->publishData(); break;
        default: ;
        }
        ...
        {
            typedef void (Data::*_t)(const QVector<double> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Data::PreasureDataReady)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Data::*_t)(const QVector<double> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Data::AngleDataReady)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Data::PreasureDataReady(const QVector<double> & _t1)
{
...
// SIGNAL 1
void Data::AngleDataReady(const QVector<double> & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
