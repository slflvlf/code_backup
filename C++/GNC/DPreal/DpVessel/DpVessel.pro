...
#INCLUDEPATH += C:\C++library\gsl\include
#LIBS += -LC:\C++library\gsl\lib -llibgsl
#LIBS += -LC:\C++library\gsl\lib -llibgslcblas
...
#win32:CONFIG(release, debug|release): LIBS += -LC:/C++library/gsl/lib/ -lgsl
#else:win32:CONFIG(debug, debug|release): LIBS += -LC:/C++library/gsl/lib/ -lgsld
#else:unix: LIBS += -LC:/C++library/gsl/lib/ -lgsl

#INCLUDEPATH += C:/C++library/gsl/include
#DEPENDPATH += C:/C++library/gsl/include



#win32:CONFIG(release, debug|release): LIBS += -LC:/C++library/gsl/lib/ -lgslcblas
#else:win32:CONFIG(debug, debug|release): LIBS += -LC:/C++library/gsl/lib/ -lgslcblasd
#else:unix: LIBS += -LC:/C++library/gsl/lib/ -lgslcblas
