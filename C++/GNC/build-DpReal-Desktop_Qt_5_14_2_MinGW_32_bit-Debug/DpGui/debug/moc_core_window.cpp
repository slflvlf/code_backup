...
void CoreWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CoreWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CoreWindow::*)(const QVector<double> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CoreWindow::poseChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CoreWindow::*)(const QVector<double> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CoreWindow::setpointChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (CoreWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CoreWindow::servo_close)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CoreWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CoreWindow.data,
    qt_meta_data_CoreWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
