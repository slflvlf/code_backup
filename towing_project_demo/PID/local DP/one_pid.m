...
s_his = p_his;
[tau_wave1_his, tau_wave2_his] = deal(zeros(3, max_step));
...
for i = 1 : max_step
    ...
    i
%     tau_env = tau_env_ship0(p);
%     tau_wind = tau_env(1:3);
%     tau_current = tau_env(4:6);
%     tau_wave1 = tau_env(7:9);
%     tau_wave2 = tau_env(10:12);
