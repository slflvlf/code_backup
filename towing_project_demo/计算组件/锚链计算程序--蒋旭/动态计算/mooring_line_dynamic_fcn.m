% function [TR1, TRN, Y_N, p_final, vv, aa] = mooring_line_dynamic_fcn(p0_next, p1_next, Y_N, vv, aa, mooring_param)
function [TR1, TRN, Y_N, p_final] = mooring_line_dynamic_fcn(p0_next, p1_next, Y_N, mooring_param)
...
% 这样写是因为我发现，原来的做法速度和加速度的更新都是基于零速度和零加速度，
% 不是基于上一步的速度和加速度
[vv, aa] = deal(zeros(3*N+3, 2));
