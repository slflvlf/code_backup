function tau_wave1 = wave_excitation_tug(pose, current_time, wave_parameters)
...
fx1_amp = force_rao_tug(:, :, 1);
fx1_phase = force_rao_tug(:, :, 2);
fy1_amp = force_rao_tug(:, :, 3);
fy1_phase = force_rao_tug(:, :, 4);
mz1_amp = force_rao_tug(:, :, 5);
mz1_phase = force_rao_tug(:, :, 6);
