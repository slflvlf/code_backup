...
static emlrtRSInfo sd_emlrtRSI = { 53, /* lineNo */
  "flt2str",                           /* fcnName */
              ...
              emxArray_real_T *xdot)
{
  ...
  t1 = 6.0 * p_ode_Nship;
  if (!(t1 >= 0.0)) {
    emlrtNonNegativeCheckR2012b(t1, &k_emlrtDCI, sp);
  }

  if (t1 != (int32_T)muDoubleScalarFloor(t1)) {
    emlrtIntegerCheckR2012b(t1, &j_emlrtDCI, sp);
  }
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &r_emlrtBCI, sp);
    }
    ...
    p3 = (int32_T)(t1 + 5.0);
    if ((p3 < 1) || (p3 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, b_u, &u_emlrtBCI, sp);
    }
    ...
    for (p3 = 0; p3 < 3; p3++) {
      p2 = (int32_T)B[p3];
      if ((p2 < 1) || (p2 > p1)) {
        emlrtDynamicBoundsCheckR2012b(p2, 1, p1, &p_emlrtBCI, sp);
      }
    ...
    for (p3 = 0; p3 < 3; p3++) {
      p2 = (int32_T)v_tmp[p3];
      if ((p2 < 1) || (p2 > p1)) {
        emlrtDynamicBoundsCheckR2012b(p2, 1, p1, &q_emlrtBCI, sp);
      }
