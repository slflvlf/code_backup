...
static emlrtRTEInfo cb_emlrtRTEI = { 14,/* lineNo */
  5,                                   /* colNo */
  "user_ode",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship\\user_ode.m"/* pName */
};
              ...
              emxArray_real_T *xdot)
{
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &i_emlrtBCI, sp);
    }

    p2 = (int32_T)(unnamed_idx_0 + 5.0);
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &i_emlrtBCI, sp);
    }
    ...
    if (p1 > u) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, u, &j_emlrtBCI, sp);
    }

    if (p2 > u) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, u, &j_emlrtBCI, sp);
    }
    ...
    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &k_emlrtBCI, sp);
    }

    b_unnamed_idx_0 = x[p1 - 1];
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &k_emlrtBCI, sp);
    }

    unnamed_idx_1 = x[p2 - 1];
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &k_emlrtBCI, sp);
    }
    ...
    if ((i2 < 1) || (i2 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, b_u, &l_emlrtBCI, sp);
    }

    i3 = (int32_T)(unnamed_idx_0 + 2.0);
    if ((i3 < 1) || (i3 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, b_u, &l_emlrtBCI, sp);
    }

    if ((i1 < 1) || (i1 > b_u)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, b_u, &l_emlrtBCI, sp);
    }

    if ((p1 < 1) || (p1 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p1, 1, 12, &m_emlrtBCI, sp);
    }

    b_unnamed_idx_0 = x[p1 - 1];
    if ((p2 < 1) || (p2 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p2, 1, 12, &m_emlrtBCI, sp);
    }

    unnamed_idx_1 = x[p2 - 1];
    if ((p3 < 1) || (p3 > 12)) {
      emlrtDynamicBoundsCheckR2012b(p3, 1, 12, &m_emlrtBCI, sp);
    }
