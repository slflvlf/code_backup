...
% Definition of p_ocp
%-------------------------------------------------------------------------------
p_ocp.Q = diag(repmat([1e9;1e9;2e11;1;1;1], p_ode.Nship, 1));%多条船的增益系数一样
p_ocp.R = diag(repmat([1e5; 1e5; 1e5; 0; 0; 0]*1e0*1, p_ode.Nship, 1));
p_ocp.Rdu = diag(repmat([1; 1; 1; 1e5; 1e5; 1e5]*1e0*1, p_ode.Nship, 1));
...
guidance_param = struct("T", 60, "p0_init", p00, "leader_destination", leader_detination,...
