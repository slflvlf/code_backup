         ...
         *g)
{
  ...
  emxInit_real_T(sp, &unusedU0, 1, &p_emlrtRTEI, true);
  emxInit_real_T(sp, &xx, 2, &p_emlrtRTEI, true);
  emxInit_real_T(sp, &uu, 2, &p_emlrtRTEI, true);
  p[i - 1] = eta;
  st.site = &emlrtRSI;
  ...
  user_ocp(&st, xx, uu, param->ode.Nship, param->ode.u0, param->uparam.Np,
           param->ocp.Q, param->ocp.R, param->ocp.xd_his, param->ocp.dF_max,
