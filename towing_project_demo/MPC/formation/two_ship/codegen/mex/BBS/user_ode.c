...
static emlrtRSInfo u_emlrtRSI = { 36,  /* lineNo */
  "user_ode",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship\\user_ode.m"/* pathName */
};
...
static emlrtRTEInfo db_emlrtRTEI = { 14,/* lineNo */
  5,                                   /* colNo */
  "user_ode",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship\\user_ode.m"/* pName */
};
              ...
              emxArray_real_T *xdot)
{
  ...
  if (!(R_tmp >= 0.0)) {
    emlrtNonNegativeCheckR2012b(R_tmp, &g_emlrtDCI, sp);
  }

  if (R_tmp != (int32_T)muDoubleScalarFloor(R_tmp)) {
    emlrtIntegerCheckR2012b(R_tmp, &f_emlrtDCI, sp);
  }

  i = xdot->size[0];
  xdot->size[0] = (int32_T)R_tmp;
  emxEnsureCapacity_real_T(sp, xdot, i, &db_emlrtRTEI);
  R_tmp = 6.0 * p_ode_Nship;
  if (!(R_tmp >= 0.0)) {
    emlrtNonNegativeCheckR2012b(R_tmp, &g_emlrtDCI, sp);
  }
  ...
  if (4 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(4, 1, u_size[0], &j_emlrtBCI, sp);
  }

  if (5 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(5, 1, 4, &j_emlrtBCI, sp);
  }

  if (6 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(6, 1, 5, &j_emlrtBCI, sp);
  }
  ...
  for (i1 = 0; i1 < 3; i1++) {
    loop_ub = i1 + 1;
    if (loop_ub > i) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 1, i, &i_emlrtBCI, sp);
    }
  ...
  for (i = 0; i < 3; i++) {
    i1 = i + 4;
    if (i1 > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, loop_ub, &h_emlrtBCI, sp);
    }
  ...
  indexShapeCheck(&st, u_size[0]);
  if (10 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(10, 1, u_size[0], &k_emlrtBCI, sp);
  }

  if (11 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(11, 1, 10, &k_emlrtBCI, sp);
  }

  if (12 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(12, 1, 11, &k_emlrtBCI, sp);
  }
  ...
  for (i = 0; i < 3; i++) {
    i1 = i + 7;
    if (i1 > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, loop_ub, &g_emlrtBCI, sp);
    }
  ...
  for (i = 0; i < 3; i++) {
    i1 = i + 10;
    if (i1 > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, loop_ub, &f_emlrtBCI, sp);
    }
