...
static emlrtRTEInfo ib_emlrtRTEI = { 10,/* lineNo */
  5,                                   /* colNo */
  "user_control_profile",              /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship\\user_control_profile.m"/* pName */
};
  ...
  emxArray_real_T *u_profile)
{
  ...
  emxEnsureCapacity_real_T(sp, u_profile, i, &ib_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
