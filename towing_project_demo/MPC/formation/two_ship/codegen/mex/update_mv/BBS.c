...
void BBS(const emlrtStack *sp, real_T eta, const real_T param_p[48], real_T
         ...
         real_T param_ode_rk_order, const real_T param_ode_u0[12], const real_T
         param_ode_M[9], const real_T param_ode_D[9], const real_T
         ...
         param_x0[12], real_T *J, real_T *g)
{
  ...
  emxInit_real_T(sp, &unusedU0, 1, &v_emlrtRTEI, true);
  emxInit_real_T(sp, &xx, 2, &v_emlrtRTEI, true);
  emxInit_real_T(sp, &uu, 2, &v_emlrtRTEI, true);
  p[i - 1] = eta;
  st.site = &u_emlrtRSI;
  simulate_ol(&st, p, param_ode_Nship, param_ode_tau, param_ode_rk_order,
              param_x0, param_ode_M, param_ode_D, param_ode_thrust_config,
              param_uparam_nu, param_uparam_Np, param_uparam_R, unusedU0, xx, uu);
  st.site = &v_emlrtRSI;
  user_ocp(&st, xx, uu, param_ode_Nship, param_ode_u0, param_uparam_Np,
           param_ocp->Q, param_ocp->R, param_ocp->xd_his, param_ocp->dF_max,
