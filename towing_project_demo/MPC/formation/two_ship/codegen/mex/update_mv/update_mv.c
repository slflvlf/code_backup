...
static emlrtRTEInfo s_emlrtRTEI = { 11,/* lineNo */
  1,                                   /* colNo */
  "update_mv",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_mv.m"/* pName */
};

static emlrtRTEInfo t_emlrtRTEI = { 37,/* lineNo */
  6,                                   /* colNo */
  "update_mv",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_mv.m"/* pName */
};

static emlrtRTEInfo u_emlrtRTEI = { 37,/* lineNo */
  1,                                   /* colNo */
  "update_mv",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_mv.m"/* pName */
};
...
void update_mv(const emlrtStack *sp, struct0_T mv[48], const real_T subset_data[],
               const int32_T subset_size[1], struct1_T *param, emxArray_real_T
               *u_sol, real_T p_sol[48], emxArray_real_T *lesp)
{
  real_T ell;
  real_T Nloop;
  int32_T i;
  ...
  /* --------------------------------------------------------- */
  ell = (param->Nev - 1.0) / (192.0 * param->Niter);
  if (ell < 0.0) {
  ...
  lesp->size[1] = i;
  emxEnsureCapacity_real_T(sp, lesp, b_i, &s_emlrtRTEI);
  ell = Nloop * 48.0;
  i = (int32_T)ell;
  if (ell != i) {
  ...
  for (c_i = 0; c_i < i; c_i++) {
    for (sig = 0; sig < loop_ub; sig++) {
      ...
      for (b_i = 0; b_i < 48; b_i++) {
        param->p[b_i] = lesp->data[b_i + 48 * ((int32_T)ind - 1)];
      ...
      if (((int32_T)ell < 1) || ((int32_T)ell > 48)) {
        emlrtDynamicBoundsCheckR2012b((int32_T)ell, 1, 48, &g_emlrtBCI, sp);
      }
      ...
      b_i = (int32_T)ind - 1;
      mv[(int32_T)ell - 1].p = lesp->data[((int32_T)ell + 48 * b_i) - 1];
      st.site = &emlrtRSI;
      ...
      for (i1 = 0; i1 < 48; i1++) {
        c_lesp[i1] = lesp->data[i1 + 48 * b_i];
      }

      for (b_i = 0; b_i < 48; b_i++) {
        lesp->data[b_i + 48 * (int32_T)ind] = c_lesp[b_i];
      }
      ...
      lesp->data[((int32_T)ell + 48 * (b_i - 1)) - 1] = mv[(int32_T)ell - 1].p;
  ...
  emxInit_real_T(sp, &b_lesp, 2, &t_emlrtRTEI, true);
  i = b_lesp->size[0] * b_lesp->size[1];
  b_lesp->size[0] = 48;
  b_lesp->size[1] = loop_ub;
  emxEnsureCapacity_real_T(sp, b_lesp, i, &t_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
    for (b_i = 0; b_i < 48; b_i++) {
      i1 = b_i + 48 * i;
  ...
  emxEnsureCapacity_real_T(sp, lesp, i, &u_emlrtRTEI);
  ...
  for (i = 0; i < 48; i++) {
    p_sol[i] = lesp->data[i + 48 * (lesp->size[1] - 1)];
  }

  loop_ub = lesp->size[1];
  st.site = &b_emlrtRSI;
  user_control_profile(&st, *(real_T (*)[48])&lesp->data[48 * (loop_ub - 1)],
