...
% Definition of p_ocp
%-------------------------------------------------------------------------------
p_ocp.Q = diag(repmat([1e7;1e7;2e9;0;0;0], p_ode.Nship, 1));%多条船的增益系数一样
p_ocp.R = diag(repmat([1e3; 1e3; 1e3; 0; 0; 0]*1e0*1, p_ode.Nship, 1));
...
guidance_param = struct("T", 40, "p0_init", p00, "leader_destination", leader_detination,...
