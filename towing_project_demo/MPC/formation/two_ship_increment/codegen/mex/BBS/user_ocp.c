...
static emlrtRSInfo db_emlrtRSI = { 40, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship_increment\\user_ocp.m"/* pathName */
};
...
static emlrtRSInfo qb_emlrtRSI = { 992,/* lineNo */
  "minOrMaxRealVectorKernel",          /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo rb_emlrtRSI = { 924,/* lineNo */
  "minOrMaxRealVector",                /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo sb_emlrtRSI = { 975,/* lineNo */
  "findFirst",                         /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};
...
static emlrtRTEInfo eb_emlrtRTEI = { 17,/* lineNo */
  1,                                   /* colNo */
  "user_ocp",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\formation\\two_ship_increment\\user_ocp.m"/* pName */
};
              ...
              real_T *g)
{
  ...
  emxInit_real_T(sp, &uplus_min, 1, &hb_emlrtRTEI, true);
  emxInit_real_T(sp, &uplus_max, 1, &ib_emlrtRTEI, true);
  ...
  *J = 0.0;
  ...
  emxEnsureCapacity_real_T(sp, h1_du, idx, &db_emlrtRTEI);
  if (p_uparam_Np != k) {
    emlrtIntegerCheckR2012b(p_uparam_Np, &h_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, h2_du, idx, &eb_emlrtRTEI);
  ...
  emxInit_real_T(sp, &u_plus, 1, &fb_emlrtRTEI, true);
  if (0 <= loop_ub - 1) {
    d = 6.0 * p_ode_Nship;
    d1 = 6.0 * p_ode_Nship;
  ...
  for (i = 0; i < loop_ub; i++) {
    if (!(d >= 0.0)) {
      emlrtNonNegativeCheckR2012b(d, &l_emlrtDCI, sp);
    }
    ...
    emxEnsureCapacity_real_T(sp, u_plus, k, &fb_emlrtRTEI);
    if (!(d1 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(d1, &l_emlrtDCI, sp);
    }
    ...
    for (j = 0; j <= i; j++) {
      k = (int32_T)(j + 1U);
      if (k > uu->size[0]) {
        emlrtDynamicBoundsCheckR2012b(k, 1, uu->size[0], &r_emlrtBCI, sp);
      }
    ...
    k = u_plus->size[0];
    u_plus->size[0] = 12;
    emxEnsureCapacity_real_T(&e_st, u_plus, k, &gb_emlrtRTEI);
    for (k = 0; k < 12; k++) {
    ...
    if (idx == 0) {
      k = (int32_T)(i + 1U);
      if (k > h1_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(k, 1, h1_du->size[0], &s_emlrtBCI, &f_st);
      }
    ...
    if (idx == 0) {
      k = (int32_T)(i + 1U);
      if (k > h2_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(k, 1, h2_du->size[0], &t_emlrtBCI, &f_st);
      }
    ...
    k = (int32_T)(i + 2U);
    if ((k < 1) || (k > xx->size[0])) {
      emlrtDynamicBoundsCheckR2012b(k, 1, xx->size[0], &q_emlrtBCI, sp);
    }
    ...
    k = i + 1;
    if (k > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(k, 1, uu->size[0], &o_emlrtBCI, sp);
    }

    st.site = &db_emlrtRSI;
    k = i + 1;
    if (k > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(k, 1, uu->size[0], &p_emlrtBCI, &st);
    }
