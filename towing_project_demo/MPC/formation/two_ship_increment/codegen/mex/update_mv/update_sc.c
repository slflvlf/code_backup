...
static emlrtDCInfo r_emlrtDCI = { 10,  /* lineNo */
  12,                                  /* colNo */
  "update_sc",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_sc.m",/* pName */
  1                                    /* checkKind */
...
static emlrtRTEInfo sb_emlrtRTEI = { 10,/* lineNo */
  6,                                   /* colNo */
  "update_sc",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_sc.m"/* pName */
};
...
static emlrtRTEInfo ub_emlrtRTEI = { 7,/* lineNo */
  19,                                  /* colNo */
  "update_sc",                         /* fName */
  "C:\\\\Users\\\\jiang\\\\Desktop\\\\towing_project_demo\\\\\xe8\xae\xa1\xe7\xae\x97\xe7\xbb\x84\xe4\xbb\xb6\\\\pdfmpc\\\\update_sc.m"/* pName */
};
               ...
               real_T Niter)
{
  ...
  BBS(&st, sc_past->p, param->p, param->ell, param->uparam.nu, param->uparam.Np,
      ...
      param->ode.u_last, param->ode.M, param->ode.D, param->ode.thrust_config,
      &param->ocp, param->x0, &Jcurrent, &gcurrent);
  if (!(Niter >= 0.0)) {
    emlrtNonNegativeCheckR2012b(Niter, &s_emlrtDCI, sp);
  }

  if (Niter != (int32_T)muDoubleScalarFloor(Niter)) {
    emlrtIntegerCheckR2012b(Niter, &r_emlrtDCI, sp);
  }

  emxInit_real_T(sp, &lesalpha, 1, &ub_emlrtRTEI, true);
  loop_ub = (int32_T)Niter;
  i = lesalpha->size[0];
  lesalpha->size[0] = loop_ub;
  emxEnsureCapacity_real_T(sp, lesalpha, i, &rb_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
    lesalpha->data[i] = 0.0;
  }

  emxInit_real_T(sp, &lesp, 1, &tb_emlrtRTEI, true);
  emlrtForLoopVectorCheckR2012b(1.0, 1.0, Niter, mxDOUBLE_CLASS, (int32_T)Niter,
    &q_emlrtRTEI, sp);
  i = lesp->size[0];
  lesp->size[0] = loop_ub;
  emxEnsureCapacity_real_T(sp, lesp, i, &sb_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    if (sc_past->qgmax <= 0.0) {
      ...
      BBS(&st, sc_past->pJmin, param->p, param->ell, param->uparam.nu,
          ...
          param->ode.rk_order, param->ode.u_last, param->ode.M, param->ode.D,
