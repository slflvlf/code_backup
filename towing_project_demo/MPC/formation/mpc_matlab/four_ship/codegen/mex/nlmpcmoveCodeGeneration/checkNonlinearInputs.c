                             ...
                             const real_T d_nonlcon_workspace_runtimedata[192])
{
  ...
  c_nlmpcmoveCodeGeneration_anonF(
      ...
      SD->u4.f10.varargout_3_data, varargout_3_size, SD->u4.f10.varargout_4);
  if ((varargout_3_size[0] != 0) && (varargout_3_size[1] != 0) &&
      ((varargout_3_size[0] != 265) ||
       (varargout_3_size[1] != varargout_1_size[0] * varargout_1_size[1]))) {
    emlrtErrorWithMessageIdR2018a(
        sp, &l_emlrtRTEI, "optimlib:fmincon:WrongSizeGradNonlinIneq",
        "optimlib:fmincon:WrongSizeGradNonlinIneq", 4, 6, 265.0, 6,
