                      ...
                      const real_T lambda_data[], int32_T lambda_size)
{
  ...
  for (iL0 = 0; iL0 < nVar; iL0++) {
    if ((iL0 + 1 < 1) || (iL0 + 1 > grad_size)) {
      emlrtDynamicBoundsCheckR2012b(iL0 + 1, 1, grad_size, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  for (idx = 0; idx < mFixed; idx++) {
    if ((idx + 1 < 1) || (idx + 1 > finiteFixed_size)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, finiteFixed_size, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if ((idx + 1 < 1) || (idx + 1 > lambda_size)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, lambda_size, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    workspace_data[finiteFixed_data[idx] - 1] += lambda_data[idx];
  }
  st.site = &cd_emlrtRSI;
  xgemv(nVar, 192, AeqTrans_data, ldA, lambda_data, mFixed + 1, workspace_data);
  st.site = &cd_emlrtRSI;
  xgemv(nVar, mIneq, AineqTrans_data, ldA, lambda_data, mFixed + 193,
        workspace_data);
  iL0 = (mFixed + mIneq) + 193;
  st.site = &cd_emlrtRSI;
  if (mLB > 2147483646) {
    b_st.site = &db_emlrtRSI;
    check_forloop_overflow_error(&b_st);
  ...
  for (idx = 0; idx < mLB; idx++) {
    ...
    if ((idx + 1 < 1) || (idx + 1 > finiteLB_size)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, finiteLB_size, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i = workspace_size[0] * workspace_size[1];
    if ((finiteLB_data[idx] < 1) || (finiteLB_data[idx] > i)) {
      emlrtDynamicBoundsCheckR2012b(finiteLB_data[idx], 1, i, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i1 = iL0 + idx;
    if ((i1 < 1) || (i1 > lambda_size)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, lambda_size, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    if ((finiteLB_data[idx] < 1) || (finiteLB_data[idx] > i)) {
      emlrtDynamicBoundsCheckR2012b(finiteLB_data[idx], 1, i, &qe_emlrtBCI,
  ...
  for (idx = 0; idx < mUB; idx++) {
    if ((idx + 1 < 1) || (idx + 1 > finiteUB_size)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, finiteUB_size, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i = iL0 + idx;
    if ((i < 1) || (i > lambda_size)) {
      emlrtDynamicBoundsCheckR2012b(i, 1, lambda_size, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
                    ...
                    int32_T lambda_size)
{
  ...
  for (idx = 0; idx < mLB; idx++) {
    ...
    if ((finiteLB_data[idx] < 1) || (finiteLB_data[idx] > b_i)) {
      emlrtDynamicBoundsCheckR2012b(finiteLB_data[idx], 1, b_i, &qe_emlrtBCI,
                                    (emlrtCTX)sp);
    }
