...
void fmincon(c_nlmpcmoveCodeGenerationStackD *SD, const emlrtStack *sp,
             ...
             const k_struct_T *fun_workspace_userdata, const real_T x0[265],
             const real_T Aineq_data[], const int32_T Aineq_size[2],
             const real_T bineq_data[], int32_T bineq_size,
             const real_T lb[265], const real_T ub[265],
             const l_struct_T *nonlcon_workspace_runtimedata,
             const k_struct_T *nonlcon_workspace_userdata, real_T x[265],
