              ...
              const d_struct_T *qpoptions)
{
  ...
  SD->u2.f7.WorkingSet = *WorkingSet;
  st.site = &sh_emlrtRSI;
  updateWorkingSet(&st, &SD->u2.f7.WorkingSet, TrialState->cIneq.data,
  ...
  *WorkingSet = SD->u2.f7.WorkingSet;
  ...
  if (!success) {
    st.site = &sh_emlrtRSI;
    c_xcopy(mConstrMax, TrialState->lambdaStopTest.data,
