...
void fmincon(c_nlmpcmoveCodeGenerationStackD *SD, const emlrtStack *sp,
             ...
             const k_struct_T *fun_workspace_userdata, const real_T x0[79],
             const real_T Aineq_data[], const int32_T Aineq_size[2],
             const real_T bineq_data[], int32_T bineq_size, const real_T lb[79],
             const real_T ub[79],
             const l_struct_T *nonlcon_workspace_runtimedata,
             const k_struct_T *nonlcon_workspace_userdata, real_T x[79],
             real_T *fval, real_T *exitflag, c_struct_T *output)
{
  ...
  mIneq = (bineq_size + mNonlinIneq) + 200;
  ...
  SD->f7.TrialState.mIneq = mIneq - 200;
  SD->f7.TrialState.mEq = 60;
  SD->f7.TrialState.iNonIneq0 = (mIneq - mNonlinIneq) - 199;
  SD->f7.TrialState.iNonEq0 = 1;
  SD->f7.TrialState.sqpFval_old = 0.0;
  SD->f7.TrialState.cIneq.size[0] = mIneq - 200;
  SD->f7.TrialState.cIneq_old.size[0] = mIneq - 200;
  ...
  memcpy(&SD->f7.TrialState.xstarsqp[0], &x0[0], 79U * sizeof(real_T));
  ...
  SD->f7.WorkingSet.nVar = 79;
  SD->f7.WorkingSet.nVarOrig = 79;
  SD->f7.WorkingSet.nVarMax = mIneq;
  SD->f7.WorkingSet.ldA = mIneq;
  SD->f7.WorkingSet.Aineq.size[0] = (mIneq - 200) * mIneq;
  SD->f7.WorkingSet.bineq.size[0] = mIneq - 200;
  ...
  st.site = &gb_emlrtRSI;
  loadProblem(&st, &SD->f7.WorkingSet, mIneq - 200, bineq_size, Aineq_data,
  ...
  updateWorkingSetForNewQP(
      &st, x0, &SD->f7.WorkingSet, mIneq - 200, SD->f7.TrialState.cIneq.data,
  ...
  MeritFunction.initConstrViolationIneq = computeConstrViolationIneq_(
      &b_st, mIneq - 200, SD->f7.TrialState.cIneq.data,
  ...
  *exitflag = SD->f7.TrialState.sqpExitFlag;
  ...
  for (mConstrMax = 0; mConstrMax < 79; mConstrMax++) {
    real_T absxk;
