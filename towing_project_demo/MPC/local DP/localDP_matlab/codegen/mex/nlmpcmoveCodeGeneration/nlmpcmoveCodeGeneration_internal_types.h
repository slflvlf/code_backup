...
#ifndef struct_emxArray_real_T_559
#define struct_emxArray_real_T_559
struct emxArray_real_T_559 {
  real_T data[559];
  int32_T size[1];
};
#endif /* struct_emxArray_real_T_559 */
#ifndef typedef_emxArray_real_T_559
#define typedef_emxArray_real_T_559
typedef struct emxArray_real_T_559 emxArray_real_T_559;
#endif /* typedef_emxArray_real_T_559 */

#ifndef typedef_f_struct_T
#define typedef_f_struct_T
typedef struct {
  emxArray_real_T_560 grad;
  emxArray_real_T_559 Hx;
  boolean_T hasLinear;
  int32_T nvar;
  int32_T maxVar;
  real_T beta;
