...
real_T computeComplError(
    ...
    int32_T fscales_cineq_constraint_size, const real_T xCurrent[79],
    int32_T mIneq, const real_T cIneq_data[], int32_T cIneq_size,
    const int32_T finiteLB_data[], int32_T finiteLB_size, int32_T mLB,
    const real_T lb[79], const int32_T finiteUB_data[], int32_T finiteUB_size,
    int32_T mUB, const real_T lambda_data[], int32_T lambda_size, int32_T iL0)
{
  ...
  if ((mIneq + mLB) + mUB > 0) {
    ...
    for (idx = 0; idx < fscales_lineq_constraint_size; idx++) {
      ...
      if (idx + 1 > cIneq_size) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, cIneq_size, &m_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      i = iL0 + idx;
      if ((i < 1) || (i > lambda_size)) {
        emlrtDynamicBoundsCheckR2012b(i, 1, lambda_size, &m_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (idx + 1 > cIneq_size) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, cIneq_size, &m_emlrtBCI,
    ...
    for (idx = 0; idx < fscales_cineq_constraint_size; idx++) {
      ...
      if (i > cIneq_size) {
        emlrtDynamicBoundsCheckR2012b(i, 1, cIneq_size, &m_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      ubOffset = (iLineq0 + idx) + 1;
      if ((ubOffset < 1) || (ubOffset > lambda_size)) {
        emlrtDynamicBoundsCheckR2012b(ubOffset, 1, lambda_size, &m_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if (i > cIneq_size) {
        emlrtDynamicBoundsCheckR2012b(i, 1, cIneq_size, &m_emlrtBCI,
    ...
    for (idx = 0; idx < mLB; idx++) {
      if ((idx + 1 < 1) || (idx + 1 > finiteLB_size)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, finiteLB_size, &m_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      if ((finiteLB_data[idx] < 1) || (finiteLB_data[idx] > 79)) {
        emlrtDynamicBoundsCheckR2012b(finiteLB_data[idx], 1, 79, &n_emlrtBCI,
                                      (emlrtCTX)sp);
      }
    ...
    for (idx = 0; idx < mUB; idx++) {
      if ((idx + 1 < 1) || (idx + 1 > finiteUB_size)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, finiteUB_size, &m_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      i = ubOffset + idx;
      if ((i < 1) || (i > lambda_size)) {
