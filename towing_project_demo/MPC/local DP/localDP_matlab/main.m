...
v0 = [0; 0; 0];
u0 = [10 5 5 pi 0 0]';
u0 = [10 10 10 0 deg2rad(30) deg2rad(-30)]';
%% 生成运动方程和相应的雅可比矩阵
...
nlobj.MV = struct('Min',{0; 0; 0; deg2rad(-145); deg2rad(-145); deg2rad(-145)},...
    'Max',{Fmax; Fmax; Fmax; deg2rad(145); deg2rad(145); deg2rad(45)},...
...
nlobj.Weights.OutputVariables = [250 250 250 0 0 0]*500;
