              ...
              p_ode_D[9], const real_T p_ode_thrust_config[8], real_T xdot[6])
{
  ...
  if (5 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(5, 1, u_size[0], &p_emlrtBCI, sp);
  }
  ...
  if (7 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(7, 1, 6, &p_emlrtBCI, sp);
  }

  if (8 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(8, 1, 7, &p_emlrtBCI, sp);
  }
