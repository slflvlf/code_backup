...
static emlrtRSInfo ub_emlrtRSI = { 22, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_4thrust\\user_ocp.m"/* pathName */
};
...
static emlrtRSInfo xb_emlrtRSI = { 28, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_4thrust\\user_ocp.m"/* pathName */
};

static emlrtRSInfo yb_emlrtRSI = { 30, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_4thrust\\user_ocp.m"/* pathName */
};
...
static emlrtRSInfo bc_emlrtRSI = { 44, /* lineNo */
  "minOrMax",                          /* fcnName */
...
static emlrtRSInfo dc_emlrtRSI = { 145,/* lineNo */
  "unaryMinOrMax",                     /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo ec_emlrtRSI = { 1019,/* lineNo */
  "maxRealVectorOmitNaN",              /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo fc_emlrtRSI = { 932,/* lineNo */
  "minOrMaxRealVector",                /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo gc_emlrtRSI = { 992,/* lineNo */
...
static emlrtRSInfo ic_emlrtRSI = { 924,/* lineNo */
  "minOrMaxRealVector",                /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo jc_emlrtRSI = { 975,/* lineNo */
  "findFirst",                         /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020a\\toolbox\\eml\\eml\\+coder\\+internal\\unaryMinOrMax.m"/* pathName */
};

static emlrtRSInfo kc_emlrtRSI = { 48, /* lineNo */
              ...
              real_T p_ocp_da_max, real_T *J, real_T *g)
{
  ...
  *J = 0.0;
  ...
  emxEnsureCapacity_real_T(sp, h1_du, tmp_size_idx_0, &ab_emlrtRTEI);
  if (p_uparam_Np != k) {
    emlrtIntegerCheckR2012b(p_uparam_Np, &j_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, h2_du, tmp_size_idx_0, &bb_emlrtRTEI);
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    indexShapeCheck(&st, idx);
    if (1 > idx) {
      emlrtDynamicBoundsCheckR2012b(1, 1, idx, &ab_emlrtBCI, sp);
    }

    du[0] = du_data[0] / p_ocp_dF_max;
    if (2 > idx) {
      emlrtDynamicBoundsCheckR2012b(2, 1, 1, &ab_emlrtBCI, sp);
    }

    du[1] = du_data[1] / p_ocp_dF_max;
    if (3 > idx) {
      emlrtDynamicBoundsCheckR2012b(3, 1, 2, &ab_emlrtBCI, sp);
    }

    du[2] = du_data[2] / p_ocp_dF_max;
    if (4 > idx) {
      emlrtDynamicBoundsCheckR2012b(4, 1, 3, &ab_emlrtBCI, sp);
    }

    du[3] = du_data[3] / p_ocp_dF_max;
    if (5 > idx) {
      emlrtDynamicBoundsCheckR2012b(5, 1, 4, &bb_emlrtBCI, sp);
    }

    du[4] = du_data[4] / p_ocp_da_max;
    if (6 > idx) {
      emlrtDynamicBoundsCheckR2012b(6, 1, 5, &bb_emlrtBCI, sp);
    }

    du[5] = du_data[5] / p_ocp_da_max;
    if (7 > idx) {
      emlrtDynamicBoundsCheckR2012b(7, 1, 6, &bb_emlrtBCI, sp);
    }

    du[6] = du_data[6] / p_ocp_da_max;
    if (8 > idx) {
      emlrtDynamicBoundsCheckR2012b(8, 1, 7, &bb_emlrtBCI, sp);
    }
    ...
    k = x->size[0];
    x->size[0] = 8;
    emxEnsureCapacity_real_T(&e_st, x, k, &cb_emlrtRTEI);
    for (k = 0; k < 8; k++) {
      x->data[k] = du[k] - 1.0;
    }
    ...
    if (idx == 0) {
      k = (int32_T)(i + 1U);
      if (k > h1_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(k, 1, h1_du->size[0], &x_emlrtBCI, &f_st);
      }
    ...
    if (idx == 0) {
      k = (int32_T)(i + 1U);
      if (k > h2_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(k, 1, h2_du->size[0], &y_emlrtBCI, &f_st);
      }
    ...
    k = (int32_T)(i + 2U);
    if ((k < 1) || (k > xx->size[0])) {
      emlrtDynamicBoundsCheckR2012b(k, 1, xx->size[0], &t_emlrtBCI, sp);
    }
    ...
    k = i + 1;
    if (k > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(k, 1, uu->size[0], &q_emlrtBCI, sp);
    }

    st.site = &vb_emlrtRSI;
    k = i + 1;
    if (k > uu->size[0]) {
      emlrtDynamicBoundsCheckR2012b(k, 1, uu->size[0], &r_emlrtBCI, &st);
    }
