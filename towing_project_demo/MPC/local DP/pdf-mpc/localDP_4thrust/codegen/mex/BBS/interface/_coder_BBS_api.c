...
static void ab_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[5120]);
...
static void j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[5120]);
...
static void t_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, struct4_T y[32]);
...
static void ab_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[5120])
{
  static const int32_T dims[2] = { 160, 32 };

  real_T (*r)[5120];
  int32_T i;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r = (real_T (*)[5120])emlrtMxGetData(src);
  for (i = 0; i < 5120; i++) {
    ret[i] = (*r)[i];
  }
  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  t_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 9, "mv")),
                     &thisId, y->mv);
...
{
  emlrtMsgIdentifier thisId;
  static const char * fieldNames[7] = { "tau", "rk_order", "x0", "u0", "M", "D",
    "thrust_config" };
  ...
  y->tau = d_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 0,
    "tau")), &thisId);
  thisId.fIdentifier = "rk_order";
  y->rk_order = d_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0,
    1, "rk_order")), &thisId);
  thisId.fIdentifier = "x0";
  l_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 2, "x0")),
                     &thisId, y->x0);
  thisId.fIdentifier = "u0";
  m_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "u0")),
                     &thisId, y->u0);
  thisId.fIdentifier = "M";
  n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4, "M")),
                     &thisId, y->M);
  thisId.fIdentifier = "D";
  n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "D")),
                     &thisId, y->D);
  thisId.fIdentifier = "thrust_config";
  o_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6,
...
{
  emlrtMsgIdentifier thisId;
  static const char * fieldNames[6] = { "Q", "R", "Rdu", "rd", "dF_max",
    "da_max" };
  ...
  emlrtMsgIdentifier *parentId, struct4_T y[32])
{
  ...
  for (i = 0; i < 32; i++) {
    ...
    u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i, 7, "param")),
                       &thisId);
...
static void u_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId)
{
  ib_emlrt_marshallIn(sp, emlrtAlias(u), parentId);
  emlrtDestroyArray(&u);
}
