...
static emlrtRSInfo sb_emlrtRSI = { 21, /* lineNo */
  "user_ocp",                          /* fcnName */
...
static emlrtRSInfo ub_emlrtRSI = { 26, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_3thrust\\user_ocp.m"/* pathName */
};
...
static emlrtRSInfo wb_emlrtRSI = { 29, /* lineNo */
  "user_ocp",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_3thrust\\user_ocp.m"/* pathName */
};
  ...
  *J = 0.0;
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    if (idx == 0) {
      a = (int32_T)(i + 1U);
      if (a > h1_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(a, 1, h1_du->size[0], &y_emlrtBCI, &f_st);
      }
    ...
    if (idx == 0) {
      a = (int32_T)(i + 1U);
      if (a > h2_du->size[0]) {
        emlrtDynamicBoundsCheckR2012b(a, 1, h2_du->size[0], &ab_emlrtBCI, &f_st);
      }
