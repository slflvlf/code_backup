                      ...
                      struct1_T *param, struct0_T *sc)
{
  ...
  *sc = *sc_past;
  ...
  BBS(&st, sc->pbarmin, param->p, param->ell, param->uparam.nu, param->uparam.Np,
      ...
      param->ode.D, param->ode.thrust_config, &param->ocp, param->x0,
      &sc->Jpbarmin, &sc->gpbarmin);
  st.site = &lc_emlrtRSI;
  BBS(&st, sc->pc, param->p, param->ell, param->uparam.nu, param->uparam.Np,
      param->uparam.R, param->ode.tau, param->ode.rk_order, param->ode.M,
      param->ode.D, param->ode.thrust_config, &param->ocp, param->x0, &sc->Jpc,
      &sc->gpc);
  st.site = &mc_emlrtRSI;
  BBS(&st, sc->pbarmax, param->p, param->ell, param->uparam.nu, param->uparam.Np,
      param->uparam.R, param->ode.tau, param->ode.rk_order, param->ode.M,
      param->ode.D, param->ode.thrust_config, &param->ocp, param->x0,
      &sc->Jpbarmax, &sc->gpbarmax);
