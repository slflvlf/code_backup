         ...
         *g)
{
  ...
  memcpy(&p[0], &param->p[0], 24U * sizeof(real_T));
  ...
  i = (int32_T)param->ell;
  if ((i < 1) || (i > 24)) {
    emlrtDynamicBoundsCheckR2012b(i, 1, 24, &emlrtBCI, sp);
  }
  ...
  simulate_ol(&st, p, param->ode.tau, param->ode.rk_order, param->ode.x0,
              ...
              uu);
  st.site = &b_emlrtRSI;
  user_ocp(&st, xx, uu, param->uparam.Np, param->ocp.Q, param->ocp.R,
           param->ocp.Rdu, param->ocp.dF_max, param->ocp.da_max,
           param->ocp.rd_his, param->ocp.u_last, J, g);
