...
static emlrtRSInfo r_emlrtRSI = { 14,  /* lineNo */
  "user_ode",                          /* fcnName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_3thrust_env\\user_ode.m"/* pathName */
};
...
static emlrtBCInfo f_emlrtBCI = { -1,  /* iFirst */
  ...
  "u",                                 /* aName */
  "user_ode",                          /* fName */
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_3thrust_env\\user_ode.m",/* pName */
  0                                    /* checkKind */
};

static emlrtRSInfo qb_emlrtRSI = { 53, /* lineNo */
  "flt2str",                           /* fcnName */
              ...
              p_ode_D[9], const real_T p_ode_thrust_config[6], real_T xdot[6])
{
  ...
  if (4 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(4, 1, u_size[0], &f_emlrtBCI, sp);
  }

  if (5 > u_size[0]) {
    emlrtDynamicBoundsCheckR2012b(5, 1, 4, &f_emlrtBCI, sp);
  }
