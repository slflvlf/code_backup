...
static emlrtRSInfo y_emlrtRSI = { 5,   /* lineNo */
  ...
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_3thrust_env\\user_control_profile.m"/* pathName */
};
...
static emlrtRTEInfo y_emlrtRTEI = { 8, /* lineNo */
  ...
  "C:\\Users\\jiang\\Desktop\\towing_project_demo\\MPC\\local DP\\localDP_3thrust_env\\user_control_profile.m"/* pName */
};

/* Function Definitions */
void user_control_profile(const emlrtStack *sp, const real_T p[24], real_T
  p_uparam_nu, real_T p_uparam_Np, const real_T p_uparam_R[2880],
  emxArray_real_T *u_profile)
{
  ...
  emxEnsureCapacity_real_T(sp, u_profile, i, &y_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
