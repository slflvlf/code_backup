...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *mv, const
  char_T *identifier, struct0_T y[24]);
...
static void d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, struct0_T y[24]);
static void db_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[2880]);
...
static void n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, real_T y[2880]);
...
static void db_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[2880])
{
  static const int32_T dims[2] = { 120, 24 };

  real_T (*r)[2880];
  int32_T i;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r = (real_T (*)[2880])emlrtMxGetData(src);
  for (i = 0; i < 2880; i++) {
    ret[i] = (*r)[i];
  }
  ...
  emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  y->tau = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 0,
    "tau")), &thisId);
  thisId.fIdentifier = "rk_order";
  y->rk_order = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0,
    1, "rk_order")), &thisId);
  thisId.fIdentifier = "x0";
  p_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 2, "x0")),
                     &thisId, y->x0);
  thisId.fIdentifier = "u0";
  p_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "u0")),
                     &thisId, y->u0);
  thisId.fIdentifier = "M";
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4, "M")),
                     &thisId, y->M);
  thisId.fIdentifier = "D";
  q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "D")),
                     &thisId, y->D);
  thisId.fIdentifier = "thrust_config";
  r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6,
  ...
  emlrtMsgIdentifier *parentId, struct4_T *y)
{
  ...
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "rd")),
                     &thisId, y->rd);
  ...
  v_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6, "rd_his")),
                     &thisId, y->rd_his);
  thisId.fIdentifier = "u_last";
  p_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 7, "u_last")),
                     &thisId, y->u_last);
  emlrtDestroyArray(&u);
}
                   ...
                   *plhs[3])
{
  ...
  p_sol = (real_T (*)[24])mxMalloc(sizeof(real_T [24]));
  emlrtHeapReferenceStackEnterFcnR2012b(&st);
  emxInit_real_T(&st, &u_sol, 2, &db_emlrtRTEI, true);
  emxInit_real_T(&st, &lesp, 2, &db_emlrtRTEI, true);
