...
if i == max_step
    % 各个船的位置和速度曲线
    plot_pos_vel(p1_his, pd1_his, p1_hat_his,  v1_his, vd1_his, v1_hat_his,  2);
    plot_pos_vel(p2_his, pd2_his, p2_hat_his,  v2_his, vd2_his, v2_hat_his,  3);
    plot_pos_vel(p3_his, pd3_his, p3_hat_his,  v3_his, vd3_his, v3_hat_his,  4);
    plot_pos_vel(p4_his, pd4_his, p4_hat_his,  v4_his, vd4_his, v4_hat_his,  5);
...
%         axis([-50, 50, -50, 50]*2);
        ...
        hgtrans0 = initial_motion_fig(hull_x0, hull_y0, p0_hat, 0, [5, 3], 'y');
        hgtrans1 = initial_motion_fig(hull_x1, hull_y1, p1_hat, 1, [25,-20], 'm');
        hgtrans2 = initial_motion_fig(hull_x1, hull_y1, p2_hat, 2, [25, 20], 'm');
        hgtrans3 = initial_motion_fig(hull_x1, hull_y1, p3_hat, 3, [-25,20], 'm');
        hgtrans4 = initial_motion_fig(hull_x1, hull_y1, p4_hat, 4, [-25, -20], 'm');
        [line1, line2, line3, line4] = intial_moorline_fig(p0_hat, p1_hat, p2_hat, p3_hat, p4_hat, hull_x0, hull_y0, hull_x1, hull_y1);
        update_motion_fig(hgtrans0, p0_hat);
        update_motion_fig(hgtrans1, p1_hat);
        update_motion_fig(hgtrans2, p2_hat);
        update_motion_fig(hgtrans3, p3_hat);
        update_motion_fig(hgtrans4, p4_hat);
        update_moorline(line1, line2, line3, line4, p0_hat, p1_hat, p2_hat, p3_hat, p4_hat, hull_x0, hull_y0, hull_x1, hull_y1);
        pause(0.0001);
...
%% 位置和速度画图， i是图的编号
function [] = plot_pos_vel(p_his, pd_his, p_hat_his,  v_his, vd_his, v_hat_his,  i)
    % 船舶id 对应着图的id
