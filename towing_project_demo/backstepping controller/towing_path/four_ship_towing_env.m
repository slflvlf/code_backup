...
%     [pd0, dot_pd0, ddot_pd0] = ref_model_2ord(Detination, pd0, dot_pd0, wn, eta, vmax, time_step);
    ...
    % pid控制器来调整虚拟领航者的位置
    [pd0_ref, dot_pd0_ref, ddot_pd0_ref, ei_leader] = leader_guiddance_pid_controller(p0_hat, v0_hat, pd0_hat, dot_pd0_hat, pd0_ref,...
...
%% 船舶初始位置转换
function [p1, p2, p3, p4] = init_position(p0, delta10, delta20, delta30, delta40)
    R = rotate_matrix(p0);
    p1 = p0
