function [tau0_cable, tau_tug_cable, cable_length, cable_angle, cable_force0] = cable_force(p0, p1, p2, p3, p4, Kcable, cable_length0)
% 缆绳连接点在拖轮的重心
    ...
    % 缆绳起始点坐标（在母船随体坐标系） 
    R0 = rotate_matrix(p0);
    pc1_start = [hull_x0(2), hull_y0(2), 0]';
    pc1_end = R0' * ( p1 - p0);
    pc2_start = [hull_x0(1), hull_y0(1), 0]';
    pc2_end = R0' * ( p2 - p0);
    pc3_start = [hull_x0(4), hull_y0(4), 0]';
    pc3_end = R0' * ( p3 - p0);
    pc4_start = [hull_x0(3), hull_y0(3), 0]';
    pc4_end = R0' * ( p4 - p0);
    ...
    tau10 = fc1 * [ cos(belta1),  sin(belta1), -hull_y0(2) * cos(belta1) + hull_x0(2) * sin(belta1) ]';
    tau20 = fc2 * [ cos(belta2),  sin(belta2), -hull_y0(1) * cos(belta2) + hull_x0(1) * sin(belta2) ]';
    tau30 = fc3 * [ cos(belta3),  sin(belta3), -hull_y0(4) * cos(belta3) + hull_x0(4) * sin(belta3) ]';
    tau40 = fc4 * [ cos(belta4),  sin(belta4), -hull_y0(3) * cos(belta4) + hull_x0(3) * sin(belta4) ]';
