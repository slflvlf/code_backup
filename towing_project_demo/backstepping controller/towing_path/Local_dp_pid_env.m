...
MM1 = M1 + Ma1;
D1 = [MM1(1,1)/80, 0, 0; 0, MM1(2,2)/40, 0; 0, 0, MM1(3,3)/10];
...
%     [pd, dot_pd, ddot_pd] = ref_model(T, i, p0, R);
    ...
    tau_wave1 = 1 * tau_wave1;    tau_wave2 = -tau_wave2;
    tau_wind = 30 * tau_wind;    tau_current = 10 * tau_current;
...
subplot(3, 3, 3); plot(a_his(1,:));
subplot(3, 3, 6); plot(a_his(2,:));
subplot(3, 3, 9); plot(a_his(3,:));
