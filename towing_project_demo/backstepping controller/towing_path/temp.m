...
%%
clc; clear all;
wave_data = textread("wave_load_file.txt");
wave1 = [wave_data(:, 2:3), wave_data(:, 7)];
wave2 = [wave_data(:, 14:15), wave_data(:, 19)];
figure
subplot(3, 1, 1)
plot(wave_data(:, 1), wave1(:, 1)/1e3);
hold on
plot(wave_data(:, 1), wave2(:, 1)/1e3);
hold off
legend("wave1", "wave2")

subplot(3, 1, 2)
plot(wave_data(:, 1), wave1(:, 2)/1e3);
hold on
plot(wave_data(:, 1), wave2(:, 2)/1e3);
hold off
subplot(3, 1, 3)
plot(wave_data(:, 1), wave1(:, 3)/1e3);
hold on
plot(wave_data(:, 1), wave2(:, 3)/1e3);
hold off