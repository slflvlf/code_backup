...
f2 = [100;100;100]; a2 = [-50;60;-100];
f3 = [100;100;100]; a3 = [-50;60;-100];
...
for i = 1 : max_step
    ...
    [length, length_error] = distance_of_ships(p0, p1, p2, p3, p4);
...
%     pd0 = transfer_deg(pd0);
    ...
    display_motion_flag = 1;%判断是否显示动图
    figure_plot4;
...
%% 多船的间距
function [length, length_error] = distance_of_ships(p0, p1, p2, p3, p4)
