                       ...
                       const real_T ub[85])
{
  ...
  int32_T b_i;
  int32_T i;
  boolean_T b_tmp_data[45120];
  boolean_T tmp_data[45120];
  boolean_T x_data[85];
  boolean_T exitg1;
  ...
  if ((Aineq_size[0] != 0) && (Aineq_size[1] != 0) && (Aineq_size[1] != 85)) {
    emlrtErrorWithMessageIdR2018a(
        sp, &g_emlrtRTEI, "optimlib_codegen:common:WrongNumberOfColumnsInA",
        "optimlib_codegen:common:WrongNumberOfColumnsInA", 2, 12, 85);
  }
  if ((Aineq_size[0] != 0) && (Aineq_size[1] != 0) &&
