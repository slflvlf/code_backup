                             ...
                             g_struct_T *memspace)
{
  ...
  mLBOrig = (WorkingSet->sizes[3] - WorkingSet->sizes[2]) - 120;
  st.site = &nh_emlrtRSI;
  ...
  memcpy(&memspace->workspace_double.data[0], &WorkingSet->beq[0],
         60U * sizeof(real_T));
  st.site = &nh_emlrtRSI;
  d_xgemv(nVarOrig, 60, WorkingSet->Aeq.data, WorkingSet->ldA,
  ...
  for (idx = 0; idx < 60; idx++) {
    ...
    if (memspace->workspace_double.data[idx] <= 0.0) {
      ...
      i = TrialState->xstar.size[0];
      i1 = (nVarOrig + idx_positive_tmp) + 62;
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &td_emlrtBCI, (emlrtCTX)sp);
      }
      ...
      i = TrialState->xstar.size[0];
      if ((i1 + 62 < 1) || (i1 + 62 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1 + 62, 1, i, &td_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      TrialState->xstar.data[i1 + 61] = 0.0;
      st.site = &nh_emlrtRSI;
      b_st.site = &ch_emlrtRSI;
      addBoundToActiveSetMatrix_(&b_st, WorkingSet, 4,
                                 (mLBOrig + idx_positive_tmp) + 62);
