...
void modifyOverheadRegularized_(const emlrtStack *sp, h_struct_T *obj)
{
  ...
  b_st.prev = &st;
  b_st.tls = st.tls;
  mIneq_tmp = obj->sizes[2] + 85;
  offsetEq2 = obj->sizes[2] + 145;
  b = obj->sizes[0];
  st.site = &vc_emlrtRSI;
  ...
  for (idx_col = 0; idx_col < b; idx_col++) {
    ...
    for (idx_row = 86; idx_row <= b_b; idx_row++) {
      i = obj->ATwset.size[0];
  ...
  for (idx_col = 0; idx_col <= mIneq_tmp - 86; idx_col++) {
    idx_lb = idx_col + 85;
    colOffsetAineq = obj->ldA * idx_col;
    st.site = &vc_emlrtRSI;
    if (idx_col + 85 > 2147483646) {
      b_st.site = &db_emlrtRSI;
      check_forloop_overflow_error(&b_st);
    }
    for (idx_row = 86; idx_row <= idx_lb; idx_row++) {
      i = obj->Aineq.size[0];
    ...
    b = obj->nVar;
    st.site = &vc_emlrtRSI;
    if ((idx_col + 87 <= obj->nVar) && (obj->nVar > 2147483646)) {
      b_st.site = &db_emlrtRSI;
      check_forloop_overflow_error(&b_st);
    }
  ...
  for (idx_col = 0; idx_col < 60; idx_col++) {
    ...
    for (idx_row = 86; idx_row <= mIneq_tmp; idx_row++) {
      i = obj->Aeq.size[0];
      i1 = idx_row + colOffsetAineq;
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &nb_emlrtBCI, (emlrtCTX)sp);
    ...
    idx_local = b_tmp + 2;
    st.site = &vc_emlrtRSI;
    if ((b_tmp + 2 <= mIneq_tmp + 60) && (mIneq_tmp + 60 > 2147483646)) {
      b_st.site = &db_emlrtRSI;
      check_forloop_overflow_error(&b_st);
    }
    ...
    b = b_tmp + 60;
    st.site = &vc_emlrtRSI;
    if ((offsetEq2 + 1 <= b_tmp + 60) && (b_tmp + 60 > 2147483646)) {
      b_st.site = &db_emlrtRSI;
      check_forloop_overflow_error(&b_st);
    }
    ...
    i = obj->Aeq.size[0];
    if ((i1 + 61 < 1) || (i1 + 61 > i)) {
      emlrtDynamicBoundsCheckR2012b(i1 + 61, 1, i, &nb_emlrtBCI, (emlrtCTX)sp);
    }
    obj->Aeq.data[i1 + 60] = 1.0;
    i = obj->ATwset.size[0];
    i1 = (b_tmp + colOffsetATw) + 61;
    if ((i1 < 1) || (i1 > i)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, i, &nb_emlrtBCI, (emlrtCTX)sp);
    }
    ...
    b = obj->nVar;
    st.site = &vc_emlrtRSI;
    if ((b_tmp + 62 <= obj->nVar) && (obj->nVar > 2147483646)) {
      b_st.site = &db_emlrtRSI;
      check_forloop_overflow_error(&b_st);
    }
  ...
  b = obj->sizes[2] + 205;
  st.site = &vc_emlrtRSI;
  if (obj->sizes[2] + 205 > 2147483646) {
    b_st.site = &db_emlrtRSI;
    check_forloop_overflow_error(&b_st);
  }
  for (colOffsetAineq = 86; colOffsetAineq <= b; colOffsetAineq++) {
    i = obj->lb.size[0];
    if (colOffsetAineq > i) {
      emlrtDynamicBoundsCheckR2012b(colOffsetAineq, 1, i, &nb_emlrtBCI,
                                    (emlrtCTX)sp);
  ...
  for (idx_col = idx_lb; idx_col <= b; idx_col++) {
    ...
    if (obj->Wid.data[idx_col - 1] == 3) {
      ...
      idx_local = colOffsetAineq + 86;
      b_tmp = colOffsetAineq + 84;
      st.site = &vc_emlrtRSI;
      if (colOffsetAineq + 84 > 2147483646) {
        b_st.site = &db_emlrtRSI;
        check_forloop_overflow_error(&b_st);
      }
      for (idx_row = 86; idx_row <= b_tmp; idx_row++) {
        i = obj->ATwset.size[0];
        i1 = idx_row + colOffsetATw;
        if ((i1 < 1) || (i1 > i)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, i, &nb_emlrtBCI, (emlrtCTX)sp);
      ...
      i = obj->ATwset.size[0];
      i1 = (colOffsetAineq + colOffsetATw) + 85;
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &nb_emlrtBCI, (emlrtCTX)sp);
      }
      obj->ATwset.data[i1 - 1] = -1.0;
      b_b = obj->nVar;
      st.site = &vc_emlrtRSI;
      if ((colOffsetAineq + 86 <= obj->nVar) && (obj->nVar > 2147483646)) {
        b_st.site = &db_emlrtRSI;
        check_forloop_overflow_error(&b_st);
      }
