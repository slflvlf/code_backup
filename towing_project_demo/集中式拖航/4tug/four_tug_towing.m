...
nlobj.Weights.OutputVariables = [250 250 250*57.3^2 0.01 0.01 0.01]*1;
...
observer_paramters = struct('M', MM1, 'D', D1, 'G', zeros(3, 3), 'T', 1000, 'lambda', [0.1, 0.1, 0.1],...
    'w', [wave_w0, wave_w0, wave_w0], 'wc', 1.2*wave_w0, 'step_size', 1, 'K3', K4*10, 'K4', K4);
...
plot32_3lines(pd0_his, p0_his, p0_hat_his, vd0_his, v0_his, v0_hat_his, "semi motion", {"pd", "p", "p_{hat}", 'vd', 'v', 'v_{hat}'}, 2, true)
